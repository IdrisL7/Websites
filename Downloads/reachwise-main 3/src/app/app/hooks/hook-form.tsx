  ...
  return (
    <form id="hooks-form" onSubmit={onSubmit} className="mb-8">
      <div className="bg-[#14161a] border border-[#252830] rounded-xl p-6">
              ...
              >
                          ...
                          {searchResults.map((source, i) => (
                            ...
                            >
                              ...
                              <span className="flex flex-col min-w-0 flex-1">
                                ...
                                {source.title && (
                                  <span className="text-[0.6875rem] text-zinc-600 truncate leading-tight">
                                    {source.title}
                                  </span>
                                )}
                              </span>
                    ...
                    {!searching && searchError === "no_results" && (
                      <div className="p-6 text-center">
                        ...
                        <p className="text-xs text-zinc-600 mb-3">
                          Try a different spelling or enter a URL below
                        </p>
                        {!showUrlInput && (
                          <button
                            type="button"
                ...
                <div className="mt-2">
                  {!showUrlInput ? (
                    ...
                    >
                      Have a specific URL? Enter it directly
                    </button>
                  ) : (
                    <input
                      type="text"
        ...
        {/* LinkedIn URL (paid only) */}
        {isPaidUser && (
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-1">
              <svg className="h-3 w-3 text-[#0077b5]" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
              <span className="text-xs text-[#878a8f]">LinkedIn company page</span>
              <span className="text-[10px] text-[#52555a]">(optional — improves signals)</span>
            </div>
            <input
              type="url"
              value={linkedinUrl}
              onChange={(e) => setLinkedinUrl(e.target.value.trim())}
              placeholder="https://linkedin.com/company/your-target"
              className="w-full bg-[#0e0f10] border border-[#252830] rounded-lg px-3 py-2 text-sm text-[#eceae6] placeholder:text-[#52555a] focus:outline-none focus:ring-2 focus:ring-[#0077b5]/30 focus:border-[#0077b5]/40 transition-colors"
            />
          </div>
        )}
