...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute bottom-1/4 right-0 h-[500px] w-[500px] rounded-full bg-indigo-600/[0.05] blur-[128px]" />
      ...
      <div className="relative mx-auto grid max-w-[90rem] gap-12 px-6 pb-20 pt-20 lg:grid-cols-2 lg:items-center lg:gap-20 lg:px-10 lg:pb-28 lg:pt-32">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-[clamp(1.0625rem,1.5vw,1.3125rem)] leading-[1.55] text-zinc-400">
            <span className="font-semibold text-zinc-200 underline decoration-violet-500/50 underline-offset-2">
              Type a company name.
            </span>{" "}
            We surface the sources &mdash; press hits, funding rounds,
            product launches.{" "}
            <span className="font-semibold text-zinc-200 underline decoration-violet-500/50 underline-offset-2">
              Pick a buyer role,
            </span>{" "}
          ...
          <p className="mt-3 text-[0.875rem] text-zinc-500/80 tracking-[0.01em]">
            We scan press pages, TechCrunch, Reuters, LinkedIn, and more. The best signals surface automatically.
          </p>
